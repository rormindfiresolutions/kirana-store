class OrderLinesController < ApplicationController
	...
	def create
		...
		current_user.user_baskets.each do |product|
			...
			add_order_to_inventory_details(shop_product, product)
	...
	private
		...
		def add_order_to_inventory_details(shop_product, product)
			...
			shop_inventory_detail.notes = 'Sold to' + current_user.email 
